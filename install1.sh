...
### Created by John D. Fisher ( jfishe ) on 2023-01-07
...
readonly script_created="2023-01-07"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="Install stuff"
## some initialisation
action=""
script_prefix=""
script_basename=""
...
## package_to_install["command"]="apt packages"
declare -A package_to_install=(
  ...
  ["task"]="taskwarrior python3-tasklib tasksh"
  # Used by Vim
  ["ctags"]="universal-ctags" # Used by Gutentags in Vim
  ["rg"]="ripgrep"
  ["pandoc"]="pandoc"
  ["gvim"]="vim-gtk3" # GUI Vim with python3
  ["node"]="nodejs" # Used by Coc.nvim
  ["npm"]="npm" # Used by Coc.nvim
  ["shfmt"]=["shfmt"]  # Used by ALE fixer for bash
  # Try Ubuntu first and then Debian
  # https://wiki.debian.org/Latex
  # https://tug.org/texlive/debian.html
  ["tex"]="texlive texlive-latex-extra texlive-xetex"
)

# TODO:  <13-01-23, jfishe> #
...
option|p|port|Incoming SSH port|${wsl_distro_port[$WSL_DISTRO_NAME]:=2200}
